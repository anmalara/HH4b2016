...
RooPlot* fitSignal(TH1F *h, std::string mass, int color, TLegend *leg, Params &params, double bias, bool kinFit=false)
{
  ...
  {
    rangeLo=320., rangeHi=450.; 
    sg_p0=new RooRealVar("sg_p0", "sg_p0", 340., 360.);
  ...
  else if (mass=="400")
  {
    ...
    sg_p0=new RooRealVar("sg_p0", "sg_p0", 380., 430.);
    sg_p1=new RooRealVar("sg_p1", "sg_p1", 5., 30.);
    sg_p2=new RooRealVar("sg_p2", "sg_p2", 0., 5.);
    sg_p3=new RooRealVar("sg_p3", "sg_p3", 0., 7.);
  }
  ...
  {
    rangeLo=400., rangeHi=500.; 
    sg_p0=new RooRealVar("sg_p0", "sg_p0", 440., 475.);
    sg_p1=new RooRealVar("sg_p1", "sg_p1", 5., 30.);
    sg_p2=new RooRealVar("sg_p2", "sg_p2", 0., 5.);
    sg_p3=new RooRealVar("sg_p3", "sg_p3", 0., 7.);
  }
...
int Display_SignalFits_bias(std::string dir_preselection="PreselectedWithRegressionDeepCSV", std::string _reg = "reg",
			std::string dir_selection="MMRSelection_chi2", std::string _dest_dir=".",
...
>>>>>>> Daniel/master
  ...
  v_zero.push_back(0);
  string width = "";
  if(masses.at(i) =="1000" || masses.at(i) =="1200") file_histograms = "Histograms_MMR_BulkGravTohhTohbbhbb_narrow_M-";
  else width = "_narrow";
